		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="ercsell/${msg }.do" name="Form" id="Form" method="post">
						<input type="hidden" name="ERCSELL_ID" id="ERCSELL_ID" value="${pd.ERCSELL_ID}"/>
						<div id="zhongxin" style="padding-top: 13px;">
						<table id="table_report" class="table table-striped table-bordered table-hover">
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">商铺名称:</td>
							...
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">剩余数量:</td>
