...
<div class="mui-content">
    ...
    <form class="form" id="usdt">
        <div class="mui-input-row white_bg">
            <label>可用餘額</label>
            <input type="text" value="${user.USDT_WALLET}" class="mui-input-clear" readonly="readonly">
        </div>
        <div class="mui-input-row white_bg">
            <label>劃入金額</label>
            <input type="number" placeholder="請輸入劃入數量" name="num" class="mui-input-clear">
        </div>
        <div class="mui-input-row white_bg">
            <label>交易密碼</label>
            <input type="password" name="pass" id="pass1" placeholder="請輸入交易密碼">
        </div>
        <button class="public-btn" onclick="usdt()" type="button">劃入</button>
    </form>
    ...
    <form class="form" id="xmc" style="display: none;">
        <div class="mui-input-row white_bg">
            <label>可用餘額</label>
            <input type="text" value="${user.XMC_WALLET}" class="mui-input-clear" readonly="readonly">
        </div>
        <div class="mui-input-row white_bg">
            <label>劃入金額</label>
            <input type="number" placeholder="請輸入劃入數量" name="num" class="mui-input-clear">
        ...
        <button class="public-btn" onclick="xmc()" type="button">劃入</button>
    </form>
...
<script type="text/javascript">
    ...
    function server_verification(tag) {
        var url = "front/cutIn.do?tag=" + tag;
