...
<header class="mui-bar mui-bar-nav">
    ...
    <a class="mui-icon mui-pull-right" href="front/to_xmcWalletCash.do"><span>提现记录</span></a>
</header>	
	
<div class="mui-content">
	
<div class="pd_10 size_12">
    幣種余額：<font class="size_16" style="color: red;">${user.XMC_WALLET}</font>XMC
</div>
...
<p class="tishi pd_10 size_10">注：手續費 5% </p>
...
<script>
    ...
    function server_verification(num, pass) {
        var url = "front/xmcWithdrawCash.do";
