...
<div class="mui-content">
    ...
    <form class="form" id="usdt">
        <div class="mui-input-row white_bg">
            <label>可用餘額</label>
            <input type="text" value="${user.HEDGING_USDT}" class="mui-input-clear" readonly="readonly">
        </div>
        <div class="mui-input-row white_bg">
            <label>轉賬金額</label>
            <input type="number" placeholder="請輸入轉賬數量" name="num" class="mui-input-clear">
        </div>

        <div class="mui-input-row white_bg">
            <label>對方賬戶</label>
            <input type="text" placeholder="請輸入對方賬號" name="hisName" class="mui-input-clear">
        </div>
        <div class="mui-input-row white_bg">
            <label>交易密碼</label>
            <input type="password" name="pass" id="pass1" placeholder="請輸入交易密碼">
        </div>
        <p class="tishi pd_10 size_10">註：只可團隊內互轉</p>
        <button class="public-btn" onclick="usdt()" type="button">轉賬</button>
    </form>
    ...
    <form class="form" id="xmc" style="display: none;">
        <div class="mui-input-row white_bg">
            <label>可用餘額</label>
            <input type="text" value="${user.HEDGING_XMC}" class="mui-input-clear" readonly="readonly">
        </div>
        <div class="mui-input-row white_bg">
            <label>轉賬金額</label>
            <input type="number" placeholder="請輸入轉賬數量" name="num" class="mui-input-clear">
        ...
        <p class="tishi pd_10 size_10">註：只可團隊內互轉</p>
        <button class="public-btn" onclick="xmc()" type="button">轉賬</button>
    </form>
...
<script type="text/javascript">
    ...
    function server_verification(tag) {
        var url = "front/transfer.do?tag=" + tag;
