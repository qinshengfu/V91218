...
public class Const {
	...
	public static final String TIMED_TASK_VALIDITY = "timedTaskValidity_"; 		// 理财券有效期定时任务前缀

	public static final String APP_RANK = "appRankSuffix"; 				//服务器缓存前台等级表前缀
	public static final String APP_LNVESTMENT = "appLnvestment"; 				//服务器缓存前台投资列表
	public static final String APP_WHEEL = "appWheel"; 				//服务器缓存前台幸运大转盘
	public static final String APP_ABOUT = "appAbout"; 				//服务器缓存前台关于我们信息
